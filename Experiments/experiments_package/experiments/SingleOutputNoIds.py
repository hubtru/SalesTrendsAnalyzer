...
class SingleOutputNoIds(Experiment):
    ...
    def get_models(self):
        return {
            ...
            "Linear": single_step.Linear(
                window_width=3, label_width=1, feature_size=32
            ),
            "Dense": single_step.Dense(window_width=3, label_width=1, feature_size=32),
            ...
            "RNN": single_step.RNN(window_width=3, label_width=1, feature_size=32),
        }
